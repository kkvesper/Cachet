                                            ...
                                            <div role="tabpanel" class="tab-pane {{ $loop->first ? 'active' : '' }}" id="name-{{ $locale }}">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="translations[{{ $locale }}][name]" id="incident-name-{{ $locale }}" value="{{ Binput::old("names.{$locale}") }}" placeholder="{{ trans('forms.incidents.name') }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="markdown-control">
                                                        <textarea name="translations[{{ $locale }}][message]" id="incident-message-{{ $locale }}" class="form-control autosize" rows="5">{{ Binput::old("messages.{$locale}") }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
